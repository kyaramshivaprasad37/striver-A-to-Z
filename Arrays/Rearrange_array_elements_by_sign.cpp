...
// nums is preserved. The rearranged array begins with a positive integer.
...
// Approach
// Using two pointer if we encounter an element greater  than 0 then insert it
// even index of new Array and if less than zero insert in odd index.
